...
#pragma config(Sensor, I2C_1,  myEncoder,      sensorQuadEncoderOnI2CPort,    , AutoAssign )
#pragma config(Motor,  port5,           myMotor,       tmotorVex393_MC29, openLoop, encoderPort, I2C_1)
...
task main()
{
    ...
    while( true )
        ...
        writeDebugStreamLine("Value: %d", SensorValue(PID_SENSOR_INDEX));
